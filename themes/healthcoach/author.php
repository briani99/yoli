<?php healthcoach_bunch_global_variable(); 
	...
	$layout = healthcoach_set( $settings, 'author_page_layout', 'right' );
	$sidebar = healthcoach_set( $settings, 'author_page_sidebar', 'blog-sidebar' );
	$view = healthcoach_set( $settings, 'author_page_view', 'list' );
	...
	$bg = healthcoach_set($settings, 'author_page_header_img');
	$title = healthcoach_set($settings, 'author_page_header_title');
	$text = healthcoach_set($settings, 'author_page_header_text');
?>
