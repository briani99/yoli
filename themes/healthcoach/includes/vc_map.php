...
//Services
healthcoach_vc_map( array(
			"name" => esc_html__("bbPress Forums", 'healthcoach'),
			"base" => "bbp-forum-index",
			"class" => "",
			"category" => esc_html__('Jollyall', 'healthcoach'),
			"icon" => 'faqs' ,
			"params" => array(				
				array(
				   "type" => "textfield",
				   "holder" => "div",
				   "class" => "",
				   "heading" => esc_html__("Forum", 'healthcoach'),
				   "param_name" => "forum",
				   "description" => ''
				),
...
function healthcoach_bunch_custom_css_classes_for_vc_row_and_vc_column($class_string, $tag) {
...
$param = array(
  ...
  "holder" => "div",
  "class" => "",
  "heading" => esc_html__("Container", 'healthcoach'),
  "param_name" => "container",
  "value" => array('Center Page'=>true),
  "description" => esc_html__("Choose whether you want to add a container before row or not.", 'healthcoach')
);
