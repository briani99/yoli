				...
				<div class="row">
					<div class="col-md-12 clearfix">
						<div class="pull-right clearfix">
							...
							<ul class="pull-left flags" style="margin-left:20px; display: inline-block">
				...
				<div class="row">
					<div class="col-md-12 clearfix">
						...
						<a href="index.html" class="logo pull-left">
							<img class="normal" src="<?php echo get_bloginfo('template_directory'); ?>/img/logo-arbol.png" alt="Yolanda Arquero" width="100">
							<img class="negative" src="<?php echo get_bloginfo('template_directory'); ?>/img/logo-arbol-grey.png" alt="Yolanda Arquero" width="100">
						</a>
...
<ul id="menu-menu-principal" class="list-inline">
...
<a href="method-sha/index.html" class="menu-image-title-after"><span class="menu-image-title">NLP</span></a><span class='sub-menu-trigger'><i class='fa fa-angle-down'></i></span>
...
<ul class='sub-menu'>
	<li id="menu-item-1266" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1266">
		<a href="method-sha/index.html" class="menu-image-title-below menu-image-not-hovered"><img width="600" height="300" 
			src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/peso.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Loose Weight</span>
		</a>
	</li>
	<li id="menu-item-780" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-780">
		<a href="healthy-nutrition/index.html" class="menu-image-title-below menu-image-not-hovered"><img width="600" height="300" 
			src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/stopsmoking.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Stop Smoking</span></a>
	</li>
	<li id="menu-item-325" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-325">
		...
		src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/fly.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Phobias</span></a></li>
</ul></div></div>
</li>
	...
	<li id="menu-item-69742" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6972">
		...
		<span class="menu-image-title">FAQs</span></a></li>
					...
					<div class="rrss">
						...
						<a href="https://twitter.com/terapiapositiv" target="_blank"><i class="fa fa-twitter"></i></a>
						<a href="https://www.youtube.com/user/terapiapositiva/" target="_blank"><i class="fa fa-youtube-play"></i></a>
						<a href="https://www.instagram.com/yolanda_arquero/" target="_blank"><i class="fa fa-instagram"></i></a>
					</div>
</nav>
<?php elseif(get_locale() == 'es_ES') : ?>
...
<ul id="menu-menu-principal" class="list-inline">
<li id="menu-item-1267" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1267">
<a href="method-sha/index.html" class="menu-image-title-after"><span class="menu-image-title">PNL</span></a><span class='sub-menu-trigger'><i class='fa fa-angle-down'></i></span>
<div class='sub-menu-outer'><div class='container'>
<ul class='sub-menu'>
	<li id="menu-item-1266" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1266">
		<a href="method-sha/index.html" class="menu-image-title-below menu-image-not-hovered"><img width="600" height="300" 
			src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/peso.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Perder Peso</span>
		</a>
	</li>
	<li id="menu-item-780" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-780">
		<a href="healthy-nutrition/index.html" class="menu-image-title-below menu-image-not-hovered"><img width="600" height="300" 
			src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/stopsmoking.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Dejar de fumar</span></a>
	</li>
	<li id="menu-item-325" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-325">
		<a href="clinic-area/index.html" class="menu-image-title-below menu-image-not-hovered"><img width="600" height="300" 
		src="<?php echo get_bloginfo('template_directory'); ?>/img/menu/fly.jpg" class="menu-image menu-image-title-below" alt="" />
		<span class="menu-image-title">Fobias</span></a></li>
</ul></div></div>
</li>
<li id="menu-item-747" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-747">
	<a href="health-programmes/index.html" class="menu-image-title-after"><span class="menu-image-title">Coaching</span></a>
